    ...
    <div className={Styles.main}>
      <div className={Styles.heromain}>
        <div className={Styles.hero_content}>
          ...
          <Link href={"/TextBook"}>
            <button id="main-btn">About platform</button>
          </Link>

          <div className={Styles.Words_games}>
            <div className={Styles.words_main}>
              <div className={Styles.p_words}>
                <svg
                ...
                <h1>600 </h1>
                <h1 className={Styles.color_tex}>+</h1>
              </div>
              <p>Popular words</p>
            </div>
            <div className={Styles.words_main}>
        ...
        <div className={Styles.main_image}>
          <div className={Styles.image}>
            <Image src={Hero} alt="" width={500} height={500} priority></Image>
          </div>
        </div>
      </div>
    </div>
